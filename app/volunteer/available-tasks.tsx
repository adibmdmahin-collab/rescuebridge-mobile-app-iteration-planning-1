  ...
  return (
    <Screen>
      ...
      <SectionTitle
        ...
        subtitle="Iteration Planning 1 screen for viewing available tasks and accepting volunteer work."
      />
      ...
      {availableTasks.length === 0 ? (
        <EmptyState
          ...
          message="New verified tasks will appear here when coordinators publish them."
        />
      ) : (
